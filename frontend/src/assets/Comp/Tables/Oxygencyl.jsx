...
const Oxygencyl = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/search/oxygen'); // Replace with actual API URL
  ...
  const columns = [
    {
      accessorKey: "hospital._id", // Access oxygen.amount correctly
      header: ({ column }) => {
        return (
          <Button
            variant="ghost"
    ...
    {
      accessorKey: "hospital.name", // Access hospital.name correctly
      header: ({ column }) => {
        return (
    ...
    {
      accessorKey: "hospital.location", // Access hospital.location correctly
      header: ({ column }) => (
        <Button
          variant="ghost"
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
    ...
    {
      accessorKey: "hospital.powerBackup", // Access hospital.location correctly
      header: ({ column }) => (
        <Button
          variant="ghost"
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
    ...
    {
      accessorKey: "oxygen.amount", // Access oxygen.amount correctly
      header: ({ column }) => {
        return (
          <Button
            variant="ghost"
